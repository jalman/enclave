...
public class TravelTask extends Task {
	...
	public void execute() throws GameActionException {
		//RC.canMove(currentLocation.directionTo(destination)) || 
		if( (!currentLocation.equals(destination) && RC.canMove(currentLocation.directionTo(destination))) || !Mines.tryDefuse(destination, false)) {
