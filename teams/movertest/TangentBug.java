...
public class TangentBug extends NavAlg {
        ...
        public void recompute(MapLocation target) {
    		int tx1 = target.x, ty1 = target.y;
            if(this.tx==tx1 && this.ty==ty1) return;
...
//              System.out.println("hitWallPos: "+hitWallPos);
                ...
                if(!traceDirLocked && chanceGoLongWay>0 && Utils.random.nextDouble()<chanceGoLongWay) 
                        bestTraceDir = 1 - bestTraceDir;
