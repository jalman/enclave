package artillerybot1.encampment;
...
import static artillerybot1.utils.Utils.*;
...
public class ArtilleryBehavior extends RobotBehavior {
	...
	public void run() {
		...
		if(rc.isActive()){
			//System.out.println(rc.getTeam() + " " + ALLY_TEAM);
				...
				try {
					...
					if(0 <= x && x <= 16 && 0 <= y && y <= 16) {
						if (info.team == ALLY_TEAM) {
							...
							//System.out.println("Ally team weight at " + x + ", " + y + " = " + weight[x][y]);
